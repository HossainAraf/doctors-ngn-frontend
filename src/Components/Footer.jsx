...
// COMPONENT
const Footer = () => (
  <div className="bg-black1 text-white text-center">
    <p>&copy; 2024 UTech Dynamics. All rights reserved.</p>
    <ul className="flex justify-center space-x-3">
      <li><a href="https://www.linkedin.com/in/hossainaraf/" target="_blank" rel="noopener noreferrer"> <svg class="cursor-pointer rounded-md shadow-md shadow-transparent transition-all duration-300 hover:shadow-blue-200" xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 92 93" fill="none">
      ...
      <li><a href="https://www.facebook.com/hossainArafUtech" target="_blank" rel="noopener noreferrer">
    
      <svg class="cursor-pointer rounded-md shadow-md shadow-transparent transition-all duration-300 hover:shadow-blue-200" xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 92 92" fill="none">
      <rect x="0.138672" width="" height="" rx="15"/>
